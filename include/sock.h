...
struct net_ops {
	...
	int(*send_buf)(struct sock *sk, const void *buf, uint32_t len);  
	int(*sendto)(struct sock *sk, const void *buf, uint32_t len,const struct sockaddr_in* saddr);
	int(*recv_buf)(struct sock *sk, void *buf, uint32_t len);
	int(*recvfrom)(struct sock *sk, void *buf, uint32_t len, struct sockaddr_in *saddr);
